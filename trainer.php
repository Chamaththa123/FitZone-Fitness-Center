...
<head>
    ...
    <style>
    .hero-image {
        background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url("public/assets/images/StockCake-Yoga Class Indoor_1730378797.jpg");
        height: 70%;
        width: 100%;
    ...
    <div class="hero-image">
        <div class="hero-text">
            <h1 style="font-size:45px;font-weight:650"><span
                ...
                <span style='color:white;background-color:#0074D9;margin-left:-15px'>&nbsp;Trainers&nbsp;</span>
            </h1>
